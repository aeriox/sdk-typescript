 ...
 */
export function apiKeysRotateAPIKey(
  client: AerioxCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.RotateApiKeyRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/api-keys/{id}/rotate")(pathParams);
  ...
  >(
    ...
    M.jsonErr([401, 404, 409], errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
