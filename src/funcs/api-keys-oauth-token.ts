 ...
 */
export function apiKeysOauthToken(
  client: AerioxCore,
  request: operations.OauthTokenRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OauthTokenResponse,
    | errors.ErrorT
    | AerioxError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.OauthTokenRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.OauthTokenResponse$inboundSchema),
